...
file_count=$(ls $dir/21_code_examples/*.atm 2>/dev/null | wc -l)
files=$(ls $dir/21_code_examples/*.atm 2>/dev/null)
...
for test_file in $files; do
    ...
    log_file_expect=$dir/22_expected_results/$just_log_file
    log_file_actual=$dir/23_actual_results/$just_log_file
