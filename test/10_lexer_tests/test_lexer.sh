...
file_count=$(ls $dir/11_code_examples/*.atm 2>/dev/null | wc -l)
files=$(ls $dir/11_code_examples/*.atm 2>/dev/null)
...
for test_file in $files; do
    ...
    log_file_expect=$dir/12_expected_results/$just_log_file
    log_file_actual=$dir/13_actual_results/$just_log_file
